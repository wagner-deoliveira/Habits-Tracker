import logo from "../assets/habits_header.svg";
        ...
        <div className="w-full max-w-3xl mx-auto flex
            ...
            <Dialog.Root>
                <Dialog.Trigger
                    ...
                    hover:border-violet-300 transition-colors duration-75 focus:outline-none focus:ring-2
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <Dialog.Close className="absolute rounded-md right-6 text-zinc-400 hover:text-zinc-200 focus:outline-none
